...
public class CRSReaderWriterEpsgTest {
	...
	public void test7405() throws IOException {
		...
		expectedText = "COMPOUNDCRS[\"OSGB 1936 / British National Grid + ODN height\","
				...
				+ "PARAMETER[\"X-axis rotation\",0.15,ANGLEUNIT[\"arc-second\",4.84813681109536E-6]],"
				+ "PARAMETER[\"Y-axis rotation\",0.247,ANGLEUNIT[\"arc-second\",4.84813681109536E-6]],"
				+ "PARAMETER[\"Z-axis rotation\",0.842,ANGLEUNIT[\"arc-second\",4.84813681109536E-6]],"
				+ "PARAMETER[\"Scale difference\",-20.489,SCALEUNIT[\"parts per million\",1.0E-6]]],"
				+ "CS[ellipsoidal,2],AXIS[\"Easting\",east],AXIS[\"Northing\",north],"
